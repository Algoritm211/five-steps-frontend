    ...
    return (
        <div className="mainContainer">
            <div className="item N1">
                ...
                <p>якщо ти хочеш працювати в сфері освіти, навчати інших, працювати з великим обсягом текстута кращими експертами світу</p>
                <p><a href="goo.gle">Дізнатися більше</a></p>
            </div>
            <div className="subGrid justify-content-center">
                <div className="item N2">
                    <div className="d-flex" style={{height: "100%", width: "100%", flexDirection: "column", justifyContent: "flex-end"}}>
                        <div className=""><div className="col-12"><h6 className="text-dark">Інтервью з Ілоном Маском</h6>
                            <h3>Як це, бути щасливим?</h3></div></div>

                        <div className="justify-content-end">
                            <div className="col-2">
                                <p  className="text-dark align-self-end"><a href="">Переглянути</a></p></div></div>
                    </div>
                </div>
                ...
                <div className="smallGrid">
                    <div className="item N4">
                        <div className="d-flex" style={{height: "100%", flexDirection: "column", justifyContent: "flex-end"}}>
                            <div className="row"><div className="col-12"><h3 className="text-dark">EQ Test</h3>
                                <h6>На скільки розвінений твій емоційний інтелект, хлопче?</h6></div></div>
